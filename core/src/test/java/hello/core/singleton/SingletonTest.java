...
public class SingletonTest {
    @Test
    @DisplayName("스프링 없는 순수한 DI 컨테이너") // 순수한 di 컨테이너의 문제점 확인해보괴
    void pureContainer() {
        AppConfig appConfig = new AppConfig(); //appconfig가 필요하기 때문에 얘를 가져옴
        ...
        //memberService1 != memberService2 확인 당연히 달라야함
